...
export const games = pgTable("games", {
  ...
  player1Folded: boolean("player1_folded").default(false),
  player2Folded: boolean("player2_folded").default(false),
  bettingDeadline: timestamp("betting_deadline"),
  currentRound: integer("current_round").default(1),
  player1InitialCards: jsonb("player1_initial_cards").default('[]'),
  player2InitialCards: jsonb("player2_initial_cards").default('[]'),
